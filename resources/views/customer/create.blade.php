...
@endphp
@section('card-body')
<form data-sendrequest="{{route('customer.store')}}" method="post">
    @csrf
    <div class="row">
                ...
                <div class="card-body">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="conjugate" class="form-control" id="exampleInputtext1" placeholder="Nome do Conjugue" required>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="exampleInputtext1">Telefone do Conjugue</label>
                            <input type="text" name='phone_conjugate' class="form-control" id="exampleInputtext1" placeholder="Telefone do Conjugue" required>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="exampleInputtext1">Estado Civíl</label>
                            <input type="text" name="state_civil" class="form-control" id="exampleInputtext1" placeholder="Estado Civíl" required>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="exampleInputtext1">Nome da Empresa</label>
                            <input type="text" name="company" class="form-control" id="exampleInputtext1" placeholder="Estado Civíl" required>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="exampleInputtext1">Renda Mensal</label>
                            <input type="text" data-money name='income' class="form-control" id="exampleInputtext1" placeholder="Renda Mensal" required>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="exampleInputtext1">Numero de Dependentes</label>
                            <input type="text" name="dependents" class="form-control" id="exampleInputtext1" placeholder="Numero de Dependentes" required>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="exampleInputtext1">CPF</label>
                            <input type="text" name="cpf" class="form-control" id="exampleInputtext1" placeholder="CPF" required>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="exampleInputtext1">RG</label>
                            <input type="text" name='rg' class="form-control" id="exampleInputtext1" placeholder="RG" required>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="exampleInputtext1">Telefone</label>
                            <input type="text" name="phone" class="form-control" id="exampleInputtext1" placeholder="Telefone" required>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="exampleInputtext1">Telefone Residencial</label>
                            <input type="text" name="phone_residential" class="form-control" id="exampleInputtext1" placeholder="Telefone Residencial" required>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="exampleInputtext1">Telefone Comercial</label>
                            <input type="text" name='phone_commercial' class="form-control" id="exampleInputtext1" placeholder="Telefone Comercial" required>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="exampleInputtext1">Telefone Complementar</label>
                            <input type="text" name="phone_complementary" class="form-control" id="exampleInputtext1" placeholder="Telefone Complementar" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="exampleInputtext1">Nome da Mãe</label>
                            <input type="text" name="mother_name" class="form-control" id="exampleInputtext1" placeholder="Nome da mãe" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="exampleInputtext1">Nome do Pai</label>
                            <input type="text" name="father_name" class="form-control" id="exampleInputtext1" placeholder="Nome do pai" required>
                        </div>
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="email" name="email" class="form-control" id="exampleInputtext1" placeholder="Email" required>
                        </div>
                ...
                <div class="card-body">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" class="form-control" name="number" id="exampleInputFile" placeholder="Número da Residência" required>
                        </div>
                        <div class="form-group col-md-8">
                            <label for="exampleInputFile">Informações Complementares</label>
                            <input type="text" class="form-control" name="additional_information" id="exampleInputFile" placeholder="Dados Complementares" required>
                        </div>
                    </div>
                </div>
            </div>
